...
| **Owe & Owed** | Two lists — who owes us, and who we owe. Adds up a person listed more than once, and settling is a deliberate zipper-swipe, not a tap. Tap a person to record a payment against their whole balance: it clears their smallest entries first, so a big debt comes down over several payments. |
